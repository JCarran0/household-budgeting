...
### [7.2.3](https://github.com/JCarran0/household-budgeting/compare/v7.2.2...v7.2.3) (2026-09-15)


### Documentation

* **plan:** retire the stale project plan, extract the subdomain migration ([793efa4](https://github.com/JCarran0/household-budgeting/commit/793efa41c81ec68874a02c7d86dfa8bccda81788))

### [7.2.2](https://github.com/JCarran0/household-budgeting/compare/v7.2.1...v7.2.2) (2026-09-15)


### Tests

* **plaid:** assert the webhook rule that exists, not the one that used to ([e5b448a](https://github.com/JCarran0/household-budgeting/commit/e5b448a23105f4b8fed84091848c63b3904cdf17))

### [7.2.1](https://github.com/JCarran0/household-budgeting/compare/v7.2.0...v7.2.1) (2026-09-15)


### Bug Fixes

* **storage:** an error is not an absence ([744dd25](https://github.com/JCarran0/household-budgeting/commit/744dd25192e0c2e77c25355122e7f6f4d129e14b))
...
* **chat:** add an expand toggle to the chat panel ([4505e71](https://github.com/JCarran0/household-budgeting/commit/4505e7124b61e1cd46e6a79a185ef091148ee77b))
...
* **ci:** run the frontend gate when shared/ changes ([423fb4b](https://github.com/JCarran0/household-budgeting/commit/423fb4b5d6efde8ddf58590cb1bc2cec3b891e2e))
...
* **ai:** close Q-P01 and Q-P07 ([db08b9b](https://github.com/JCarran0/household-budgeting/commit/db08b9bd41263f04058240643e69740507e020ec))
...
* **deploy:** pre-flight SSM from the instance, and report the real version (TD-026, TD-027) ([e716e35](https://github.com/JCarran0/household-budgeting/commit/e716e357baadb946d4ba9ec3c874fd153876e29c)), closes [#1](https://github.com/JCarran0/household-budgeting/issues/1)


### Documentation

* **debt:** settle the TD-020 deferral and correct its repointing guidance ([865fbd8](https://github.com/JCarran0/household-budgeting/commit/865fbd86467c1e0fdec9c2d78ccf2c5c5cbc678d))

### [6.1.1](https://github.com/JCarran0/household-budgeting/compare/v6.1.0...v6.1.1) (2026-09-08)


### Bug Fixes

* **scripts:** render reconciler transaction ids so they can be told apart ([1937e7b](https://github.com/JCarran0/household-budgeting/commit/1937e7bebd5d0df63b9d5555a0715ebdf56ea781))

## [6.1.0](https://github.com/JCarran0/household-budgeting/compare/v6.0.9...v6.1.0) (2026-09-08)


### Features

* **accounts:** adopt re-provisioned Plaid accounts on re-auth (TD-020) ([b99bd28](https://github.com/JCarran0/household-budgeting/commit/b99bd283fa099598c4519aecbb77daf6feed39f5))

### [6.0.9](https://github.com/JCarran0/household-budgeting/compare/v6.0.8...v6.0.9) (2026-09-08)


### Documentation

* **security:** SA-25 resolved — historical tarball archive purged ([9c26f82](https://github.com/JCarran0/household-budgeting/commit/9c26f82d5fa1f47fbd93a8e66ea42971d18ef1bc))
...
* **deploy:** render .env from SSM without jq ([6f124e1](https://github.com/JCarran0/household-budgeting/commit/6f124e12af929c33fd8176355f37372b91417e31))
...
* **security:** stop returning Plaid credentials to the browser (SA-19) ([3e15bbf](https://github.com/JCarran0/household-budgeting/commit/3e15bbf0ef09220213855111eef8f4b86422d208))
...
* **budgets:** user-selectable, frozen row sort in Budget vs. Actuals ([a60cf5b](https://github.com/JCarran0/household-budgeting/commit/a60cf5baf87a31939e5a2b9fa460959575982c68))

### [5.82.2](https://github.com/JCarran0/household-budgeting/compare/v5.82.1...v5.82.2) (2026-08-02)


### Documentation

* TD-025 primary mitigation complete; record retrieval hazards ([84f32cd](https://github.com/JCarran0/household-budgeting/commit/84f32cd6de46be2a04ec4f38aaf6b82defe93097))

### [5.82.1](https://github.com/JCarran0/household-budgeting/compare/v5.82.0...v5.82.1) (2026-08-02)


### Documentation

* make tech-debt tracker accurate and handoff-ready ([a67556f](https://github.com/JCarran0/household-budgeting/commit/a67556f86713cfb0eb4f093c99551248e4bcadfd))

## [5.82.0](https://github.com/JCarran0/household-budgeting/compare/v5.81.7...v5.82.0) (2026-08-02)


### Features

* **ops:** add off-bucket production snapshots with drilled restore (TD-019) ([f4eb48a](https://github.com/JCarran0/household-budgeting/commit/f4eb48a5b907ae83a6603622b11f1f48e2c41049))

### [5.81.7](https://github.com/JCarran0/household-budgeting/compare/v5.81.6...v5.81.7) (2026-08-02)


### Bug Fixes

* **sync:** hold the cursor when Plaid sends an unknown account_id (TD-020) ([77c8fe5](https://github.com/JCarran0/household-budgeting/commit/77c8fe58361e214b24c84af6c23116b506cd50df))

### [5.81.6](https://github.com/JCarran0/household-budgeting/compare/v5.81.5...v5.81.6) (2026-08-02)


### Bug Fixes

* **accounts:** surface silent Plaid failures (TD-022, TD-021 step 1) ([261462b](https://github.com/JCarran0/household-budgeting/commit/261462b0cc69b28c63d1431567b4bd5869fa6f08))
...
* **dev:** correct stale local dev ports and Plaid products example ([a3f170d](https://github.com/JCarran0/household-budgeting/commit/a3f170dbe2ae9a2333967d959e5e1f8fbd5a1013))

## [5.81.0](https://github.com/JCarran0/household-budgeting/compare/v5.80.3...v5.81.0) (2026-06-19)


### Features

* **scripts:** add data anonymizer for shareable dev builds ([72e711c](https://github.com/JCarran0/household-budgeting/commit/72e711cd73496cc07d57a6ff133f32b1db1ee011))

### [5.80.3](https://github.com/JCarran0/household-budgeting/compare/v5.80.2...v5.80.3) (2026-06-14)


### Bug Fixes

* **workspaces:** make react import static in StatementHistoryTable ([9c42ecf](https://github.com/JCarran0/household-budgeting/commit/9c42ecfb56717d4eedafc8b04bee8728c7f4074c))
...
* **workspaces:** show statement footer notes for legacy/unconfigured headers ([6012c3a](https://github.com/JCarran0/household-budgeting/commit/6012c3a7ac2e5f257fddd91228fe3deeaf248e42))

## [5.80.0](https://github.com/JCarran0/household-budgeting/compare/v5.79.1...v5.80.0) (2026-06-09)


### Features

* **workspaces:** allow deleting a business statement ([b98b31c](https://github.com/JCarran0/household-budgeting/commit/b98b31c7837928f8a643de1a91f9577e04c4a366))

### [5.79.1](https://github.com/JCarran0/household-budgeting/compare/v5.79.0...v5.79.1) (2026-06-09)


### Bug Fixes

* **workspaces:** refetch workspace list on app load so switcher survives refresh ([79b21b6](https://github.com/JCarran0/household-budgeting/commit/79b21b675734ff2bf7fe58b8ca0eada0e891520d))
...
* **workspaces:** prove business-workspace transaction reuse (PR3) ([efa96cc](https://github.com/JCarran0/household-budgeting/commit/efa96cccdd1c0c1fa17bbe47e8caae1d2811bc4c))
...
* **trips:** lock tripService read-modify-write cycles (TD-011) ([5a0fe50](https://github.com/JCarran0/household-budgeting/commit/5a0fe50b1bae8f4fbeb4b5b735c3e0c4571dde65))
...
* **trips:** serialize photo-heal writes to prevent trips file corruption ([f8fc1d4](https://github.com/JCarran0/household-budgeting/commit/f8fc1d4737c40f2f99e18cd09339608302286064))

## [5.76.0](https://github.com/JCarran0/household-budgeting/compare/v5.75.2...v5.76.0) (2026-06-02)


### Features

* **trips:** self-heal stale Google Places photos on load failure ([947bfab](https://github.com/JCarran0/household-budgeting/commit/947bfab97953915d7629f35e5338364743df4605))
...
* **trips:** surface "Photo unavailable" when cover image fails ([a9f44a5](https://github.com/JCarran0/household-budgeting/commit/a9f44a5277d7e1a3cd9ae9a5c45dc61680fc8f83))
...
* **navigation:** URL-backed disclosure hook so browser Back closes modals ([032b3ce](https://github.com/JCarran0/household-budgeting/commit/032b3ce672fad7f03278483f78b4d2a4e80a2515))
...
* **auto-categorize:** match patterns across all three transaction fields ([dce0615](https://github.com/JCarran0/household-budgeting/commit/dce06151dc6b069f1c1a97880e3f412b395b4ea5))
...
* **ui:** bolden user identity colors and surface owner dot in transactions ([0ed4fdb](https://github.com/JCarran0/household-budgeting/commit/0ed4fdb1a9941f811e127a662664b1243fa48726))

## [5.66.0](https://github.com/JCarran0/household-budgeting/compare/v5.65.0...v5.66.0) (2026-05-01)


### Features

* **tasks:** tap earned badge in gallery to view in hero mode ([52e3cd2](https://github.com/JCarran0/household-budgeting/commit/52e3cd25c5d2e714503270305ef2246a1380465f))
...
* **plaid:** migrate transaction sync to cursor-based transactionsSync (TD-016) ([51043c9](https://github.com/JCarran0/household-budgeting/commit/51043c9066383d444f21430f02a618462bb79191))
...
* **actuals:** unify modal/row totals on signed accumulation (REQ-005a) ([9fa054e](https://github.com/JCarran0/household-budgeting/commit/9fa054e0f36fc91fbf0991d89a9f47d80e1e82fc))

## [5.61.0](https://github.com/JCarran0/household-budgeting/compare/v5.60.0...v5.61.0) (2026-04-26)


### Features

* **reports,dashboard:** annual cashflow forecast + BvA section rollups + unified Net Cashflow path ([52ead22](https://github.com/JCarran0/household-budgeting/commit/52ead22a0b1fce370a5fc51b0427fc2f901e6b23))
...
* **reports:** add formula tooltips to KPI cards ([839e402](https://github.com/JCarran0/household-budgeting/commit/839e402ee1de60ba60c2636b2f6c463572910974))
...
* **dashboard:** net refunds against expense, surface hidden categories ([28ded6f](https://github.com/JCarran0/household-budgeting/commit/28ded6fb04ad7f2ae26291d777e82576ea0d47c2))
...
* rename BvA II → BvA across code, tests, and live docs ([6623187](https://github.com/JCarran0/household-budgeting/commit/6623187d674b9ee26e366e8f742fd6def53bad7f))
