...
| AI Agent Learnings | [AI-AGENT-LEARNINGS-BRD.md](docs/features/AI-AGENT-LEARNINGS-BRD.md) | — |
...
- `backend/src/routes/chatbot.ts` — `refuseBusinessWorkspace` gates every AI route. The business workspace holds money held in trust for a client and is excluded from AI entirely, reads included
