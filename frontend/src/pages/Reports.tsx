...
export function Reports() {
  ...
  const budgetHealthData = useMemo(() => {
    ...
    // ---- Widget 2: Top 10 Budget Gaps (largest overspend for categories with a budget) ----
    ...
    // Threshold: 3 months, but relaxed to 1 if there are fewer months in range
      ...
      <Stack gap="lg">
        ...
        <Tabs value={activeTab} onChange={setActiveTab}>
          <Tabs.List>
            ...
            <Tabs.Tab value="budgets" leftSection={<IconTarget size={16} />}>
              Budgets
            </Tabs.Tab>
